...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lblAdimSayisi.setGeometry(QtCore.QRect(630, 170, 178, 38))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.lblA.setGeometry(QtCore.QRect(633, 110, 40, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.lblx1 = QtWidgets.QLabel(Form)
        self.lblx1.setGeometry(QtCore.QRect(790, 110, 61, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.lblx1.setStyleSheet("color:#FFFF00")
        self.lblx1.setObjectName("lblx1")
        self.lnEdtA = QtWidgets.QLineEdit(Form)
        self.lnEdtA.setGeometry(QtCore.QRect(680, 110, 101, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        ...
        self.lnEdtB.setGeometry(QtCore.QRect(850, 110, 101, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        ...
        self.lnEdtAdimSayisi.setGeometry(QtCore.QRect(800, 170, 101, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        ...
        self.btnHesapla.setGeometry(QtCore.QRect(630, 240, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.btnTemizle.setGeometry(QtCore.QRect(810, 240, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.lblSonuc.setGeometry(QtCore.QRect(300, 350, 131, 38))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.lnEdtSonuc = QtWidgets.QLineEdit(Form)
        self.lnEdtSonuc.setGeometry(QtCore.QRect(410, 350, 571, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        self.lnEdtSonuc.setFont(font)
        self.lnEdtSonuc.setStyleSheet("color:black")
        self.lnEdtSonuc.setReadOnly(True)
        self.lnEdtSonuc.setObjectName("lnEdtSonuc")
        self.btnSec = QtWidgets.QPushButton(Form)
        self.btnSec.setGeometry(QtCore.QRect(240, 240, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.btnSec.setStyleSheet("background-color:orange; color:white")
        self.btnSec.setObjectName("btnSec")
        self.lblHataPayi = QtWidgets.QLabel(Form)
        self.lblHataPayi.setGeometry(QtCore.QRect(650, 170, 178, 38))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.lblHataPayi.setFont(font)
        self.lblHataPayi.setStyleSheet("color:#FFFF00")
        self.lblHataPayi.setObjectName("lblHataPayi")
        self.lblx0 = QtWidgets.QLabel(Form)
        self.lblx0.setGeometry(QtCore.QRect(620, 110, 71, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.lblx0.setFont(font)
        self.lblx0.setStyleSheet("color:#FFFF00")
        self.lblx0.setObjectName("lblx0")
        self.lblB = QtWidgets.QLabel(Form)
        self.lblB.setGeometry(QtCore.QRect(810, 110, 40, 40))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        font.setBold(True)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Program"))
        ...
        self.cmbBoxYontem.setItemText(2, _translate("Form", "Newton Repson"))
        self.cmbBoxYontem.setItemText(3, _translate("Form", "Secant"))
        self.lblYontem.setText(_translate("Form", "Yöntem Seç :"))
        self.cmbBxFonksiyon.setItemText(0, _translate("Form", "  x^3 + 3x - 20 "))
        self.cmbBxFonksiyon.setItemText(1, _translate("Form", "  x^3 - 2x + 1 "))
        self.cmbBxFonksiyon.setItemText(2, _translate("Form", "  x - √(x +  6) "))
        self.cmbBxFonksiyon.setItemText(3, _translate("Form", "  ( x^2 - x ) / 3"))
        self.cmbBxFonksiyon.setItemText(4, _translate("Form", "  x^3 - 20x"))
        self.lblAdimSayisi.setText(_translate("Form", "Adım Sayısı :"))
        self.lblA.setText(_translate("Form", "A :"))
        self.lblx1.setText(_translate("Form", "x1 :"))
        ...
        self.btnSec.setText(_translate("Form", "Seç"))
        self.lblHataPayi.setText(_translate("Form", "Hata Payı :"))
        self.lblx0.setText(_translate("Form", "x0 :"))
